...
- Read [Security & Boundaries](../security.md) before choosing a production trust boundary.
- Read [Performance](../performance/index.md) for latency, pooling, and executor sizing guidance.
