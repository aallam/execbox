...
| [`execbox-process.ts`](https://github.com/aallam/execbox/blob/main/examples/execbox-process.ts)                     | Run the same provider flow with QuickJS hosted in a child process. | You want a stronger lifecycle boundary than inline QuickJS.                       |
